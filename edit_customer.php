<?php
  ...
  $row = mysqli_fetch_array($get_contact);
   ...
   if(isset($_POST['update'])){
    ...
    $middle_intial = $_POST['middle_initial'];
...
<body>
  ...
  <div class="form-row">
   ...
   <div class="col-md-4 mb-3">
      ...
      <input name="middle_initial" type="text" value="<?php  echo $row['middle_initial'];  ?>" class="form-control"  id="validationCustom02"  value="" required>
     </div>
